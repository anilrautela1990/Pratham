...
app.controller("projectDetails", function($scope,$http,$state,$cookieStore) {
...
//		$scope.unitDetail =  $scope.units[unitId-1];
		var projectRow = '<tr><td>'+$scope.units[unitId-1].UnitDtls_Id+'</td><td>'+$scope.units[unitId-1].UnitDtls_Type+'</td><td>Phase</td><td>'+$scope.units[unitId-1].UnitDtls_Type+'</td><td>Block '+$scope.units[unitId-1].UnitDtls_Block_Id+'</td><td>'+$scope.units[unitId-1].UnitDtls_BRoom+'BHK - '+$scope.units[unitId-1].UnitDtls_No+' - '+$scope.units[unitId-1].UnitDtls_Floor+' Floor</td></tr>';
